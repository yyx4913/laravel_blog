...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="{{url('admin/links')}}">链接列表</a> &raquo; 添加链接
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/links')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="link_name" style="width:10em;" >
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="link_title" style="width:15em;">
                ...
                <tr>
                    <th>链接排序：</th>
                    <td>
                        <input type="text" class="lg" name="link_order" style="width:5em;">
