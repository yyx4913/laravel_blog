...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 链接列表 &raquo;<a href="{{url('admin/links/create')}}"> 添加链接</a>
    </div>
    <!--面包屑导航 结束-->
        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    ...
                    <a href="javascript:;" onclick="update('{{url('admin/link/changeOrder')}}','{{csrf_token()}}')">
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">
                            <input type="text" name="link_order[{{$v->link_id}}]" value="{{$v->link_order}}"
                                  >
                        </td>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" onclick="del('{{url('admin/links/'.$v->link_id)}}','{{csrf_token()}}','该链接信息')">删除</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
