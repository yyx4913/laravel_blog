...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 配置信息</a>
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                ...
                <a href="{{url('admin/category')}}"><i class="fa fa-refresh"></i>查看分类</a>
                <a href="{{url('admin/article')}}"><i class="fa fa-refresh"></i>查看文章</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
            ...
            <ul>
                ...
                <li>
                    <label>上传附件限制</label><span><?php echo get_cfg_var("upload_max_filesize")?
                            get_cfg_var("upload_max_filesize"):'已经超过最大限制值'; ?></span>
                </li>
                <li>
                ...
                <li>
                    <label>博客-版本</label><span>v-1.0</span>
                </li>
            </ul>
        </div>
    </div>
