...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="{{url('admin/article')}}">文章列表</a> &raquo; 编辑文章
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/article/'.$data->art_id)}}" method="post">
            ...
            <table class="add_tab">
                    ...
                    <td>
                        <select name="cate_id">
                            ...
                            <option value="{{$v->cate_id}}"
                                @if($v->cate_id==$data->cate_id) selected
                                        @endif
                                >{{$v->cate_name}}</option>
                           @endforeach
                        </select>
                ...
                <tr>
                    <th>关键字：</th>
                    <td>
                        <input type="text" name="art_tag" value="{{$data->art_title}}">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="art_thumb" id="upload_img" value="{{$data->art_thumb}}">
                ...
                <tr>
                    <th></th>
                    <td>
                        <img src="{{$data->art_thumb}}" id="thumb_upload"  style="max-width:200px;max-height:100px;">
                    </td>
                </tr>
                <tr>
                    <th>描述信息：</th>
                    <td>
                        <textarea class="lg" name="art_description">{{$data->art_description}}</textarea>
                    </td>
                </tr>
                <tr>
                    <th>详细内容：</th>
                    <td>
                        ...
                        <script id="editor" type="text/plain" name="art_content" style="width:720px;height:300px;">{!! $data->art_content !!}</script>
