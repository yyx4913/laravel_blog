...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 分类管理 &raquo;<a href="{{url('admin/category/create')}}"> 添加分类</a>
    </div>
    <!--面包屑导航 结束-->
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">
                            <input type="text" name="cate_order[{{$v->cate_id}}]" value="{{$v->cate_order}}"
                                  >
                        </td>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" onclick="del('{{url('admin/category/'.$v->cate_id)}}','{{csrf_token()}}','该分类信息')">删除</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
