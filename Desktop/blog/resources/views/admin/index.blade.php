		...
		<ul>
            <li>
                ...
                <ul class="sub_menu">
                    ...
                    <li><a href="{{url('admin/category/create')}}" target="main"><i class="fa fa-fw fa-list-alt"></i>添加分类</a></li>
            ...
            <li>
                ...
                <ul class="sub_menu" style="display: block;">
					<li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-fw fa-navicon"></i>自定义菜单</a></li>
                    <li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-cubes"></i>友情链接</a></li>
					<li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-cogs"></i>系统配置</a></li>
